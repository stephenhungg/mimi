...
//
// rewritten post-livekit: agent replies come back from the POST body itself
// (since /dialogue is synchronous), and the agent's broadcast is reflected
// via the poll loop into agentStateStore.
