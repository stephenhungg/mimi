...
//
// previous v1 used livekit for multiplayer presence. removed: livekit cloud
// is high-friction for a hackathon demo, and the killshot (commit → tiger
// reacts → notion updates) works fine in single-player. agent state comes
// from notion via short polling.
